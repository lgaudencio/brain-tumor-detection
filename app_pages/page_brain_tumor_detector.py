...
def page_brain_tumor_detector_body():
    ...
    st.write(
        f"* You can download a set of healthy and tumor MRI scans for live prediction. "
        f"You can download the images from [here](https://www.kaggle.com/datasets/preetviradiya/brian-tumor-dataset)."
        )
